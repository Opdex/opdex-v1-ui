...
@Component({
  selector: 'opdex-tx-box-provide',
  templateUrl: './tx-box-provide.component.html',
  styleUrls: ['./tx-box-provide.component.scss']
})
export class TxBoxProvideComponent implements OnInit {
  form: FormGroup;
