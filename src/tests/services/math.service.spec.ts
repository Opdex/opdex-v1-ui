...
const MathTestLookup = {
  addTests: [
    ...
    { a: new FixedDecimal('-0.500000000000000000', 18), b: new FixedDecimal('1.5', 8), expectedOutput: '1.000000000000000000'}
  ],
  subtractTests: [
    ...
    { a: new FixedDecimal('0.5', 8), b: new FixedDecimal('1.50000000', 8), expectedOutput: '-1.00000000'},
    { a: new FixedDecimal('-0.5', 8), b: new FixedDecimal('1.50000000', 8), expectedOutput: '-2.00000000'},
    { a: new FixedDecimal('-0.5', 8), b: new FixedDecimal('-1.50000000', 8), expectedOutput: '1.00000000'}
  ],
  multiplyTests: [
